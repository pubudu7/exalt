...
if ( class_exists( 'WP_Customize_Control' ) ) :
	 ...
	 */
	class Exalt_Radio_Image_Control extends WP_Customize_Control {
		...
		public function enqueue() {
            ...
            wp_enqueue_style( 'exalt-radio-image-control-css', get_template_directory_uri() . '/inc/customizer/custom-controls/radio-image/radio-image.css', array(), '1.0', 'all' );
		}
