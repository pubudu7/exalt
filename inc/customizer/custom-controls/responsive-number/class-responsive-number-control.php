...
if ( class_exists( 'WP_Customize_Control' ) ) :
    ...
    class Exalt_Responsive_Number_Control extends WP_Customize_Control {
         ...
         * @var    string
         */
        public $type = 'exalt-responsive-number';
        ...
        public function enqueue() {
            wp_enqueue_script( 'exalt-responsive-number', get_template_directory_uri() . '/inc/customizer/custom-controls/responsive-number/responsive-number.js', array( 'jquery', 'customize-base' ), false, true );
        }
