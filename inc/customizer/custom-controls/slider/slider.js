wp.customize.controlConstructor['exalt-slider'] = wp.customize.Control.extend({
    ...
    ready: function() {
        ...
        var control             = this,
            ...
            rangeInput          = control.container.find( '.exalt-slider' ),
            textInput           = control.container.find( '.exalt-slider-text' ),
			resetBtn            = control.container.find( '.exalt-slider-reset' ),
